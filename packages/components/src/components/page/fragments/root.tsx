...
export const PageRoot = forwardRef<React.ComponentRef<typeof View>, Props>((_props, ref) => {
  ...
  return (
    <PageScrollContext.Provider value={{ translateY, isScrolling, lastContentOffset }}>
