...
import type { ThemeWithGetToken, BackgroundPropsType as _BackgroundPropsType } from "../../theme";
...
export const StatusBar = (_props: Props) => {
  ...
  const newProps = objectDeepMerge<BaseComponentProps>(props, parsedBackgroundProps);
